/*
 * @(#) ConnectionPair.h   1.0   Dec 14, 2011
 *
 ...
 * @(#) $Id$
 */
#ifndef SIMULATOR_CONNECTION_PAIR_H_
#define SIMULATOR_CONNECTION_PAIR_H_
...
struct ConnectPair {
	ConnectionMechanism* first;
	ConnectionMechanism* second;
};

typedef std::vector<ConnectPair*> ConnectPairVector;

typedef ConnectPairVector::iterator ConnectPairIterator;

}

#endif /* SIMULATOR_CONNECTION_PAIR_H_ */
