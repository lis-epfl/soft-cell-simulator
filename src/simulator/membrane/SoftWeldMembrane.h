/*
 * @(#) SoftWeldMembrane.h   1.0   Dec 14, 2011
 *
 ...
 * @(#) $Id$
 */
#ifndef SIMULATOR_SOFT_WELD_MEMBRANE_H_
#define SIMULATOR_SOFT_WELD_MEMBRANE_H_
...
class SoftWeldMembrane: public SoftElement {

public:

	SoftWeldMembrane(b2World* world,
			const SoftElementDef& softElementDefinition,
			const SoftMembraneDef& definition, unsigned int id);

	virtual ~SoftWeldMembrane();
	 ...
	 */
	void mergeMembrane(std::string mergeEdge, SoftWeldMembrane* other,
...
#endif /* SIMULATOR_SOFT_WELD_MEMBRANE_H_ */
